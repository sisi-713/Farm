	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'photo',title:'土地图片',width:100,align:'center',formatter:function(value,row,index){
			...
			{ field:'remark',title:'土地备注',width:200},
		]]
	});
</script>