...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>土地类型名称:</label><input id="search-name" class="wu-text" style="width:100px">
            <label>状态:</label>
            <select id="search-status" class="easyui-combobox" panelHeight="auto" style="width:120px">
            	<option value="-1">全部</option>
            	<option value="0">已租完</option>
...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                <td width="60" align="right">土地图片:</td>
            ...
            <tr>
                ...
                <td><input type="text" id="add-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地类型名称'" /></td>
            </tr>
             <tr>
                <td align="right">价格:</td>
                <td><input type="text" id="add-price" name="price" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地类型价格'" /></td>
            </tr>
            <tr>
                <td align="right">土地面积:</td>
                <td><input type="text" id="add-liveNum" name="liveNum" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地类型人数'" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="add-roomNum" name="roomNum" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地类型土地数'" /></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
           ...
           <tr>
                <td align="right">名称:</td>
                <td><input type="text" id="edit-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地类型名称'" /></td>
            </tr>
             <tr>
                <td align="right">价格:</td>
                <td><input type="text" id="edit-price" name="price" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地类型价格'" /></td>
            </tr>
            <tr>
                <td align="right">土地面积:</td>
                <td><input type="text" id="edit-liveNum" name="liveNum" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地类型人数'" /></td>
            </tr>
            <tr>
                <td align="right">土地数:</td>
                <td><input type="text" id="edit-bedNum" name="bedNum" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地类型床位数'" /></td>
            </tr>
            <tr>
                <td align="right">可用土地数:</td>
                <td><input type="text" id="edit-roomNum" name="roomNum" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地类型土地数'" /></td>
            </tr>
            <tr>
                <td align="right">状态:</td>
                <td>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'liveNum',title:'土地面积',width:100,sortable:true},
		
			{ field:'roomNum',title:'土地数',width:100,sortable:true},
			{ field:'avilableNum',title:'可用土地数',width:100,sortable:true},
			{ field:'bookNum',title:'已预定数',width:100,sortable:true},
			{ field:'livedNum',title:'已租借数',width:100,sortable:true},
			...
			{ field:'remark',title:'土地类型备注',width:200},
		]]
	});
</script>