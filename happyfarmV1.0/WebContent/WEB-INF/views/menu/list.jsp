...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>土地名称：</label><input id="search-name" class="wu-text" style="width:100px">
...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            <tr>
                <td width="60" align="right">土地名称:</td>
                <td><input type="text" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地名称'" /></td>
            </tr>
            <tr>
                <td align="right">上级土地:</td>
                <td>
            ...
            <tr>
                <td align="right">土地URL:</td>
                <td><input type="text" name="url" class="wu-text" /></td>
            </tr>
            <tr>
                <td align="right">土地图标:</td>
                <td>
                	<input type="text" id="add-icon" name="icon" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地图标'" />
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            <tr>
                <td width="60" align="right">土地名称:</td>
                <td><input type="text" id="edit-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地名称'" /></td>
            </tr>
            <tr>
                <td align="right">上级土地:</td>
                <td>
            ...
            <tr>
                <td align="right">土地图标:</td>
                <td>
                	<input type="text" id="edit-icon" name="icon" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地图标'" />
                	<a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="selectIcon()" plain="true">选择</a>
                </td>
            </tr>
        </table>
	...
	<form id="add-menu-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                	<input type="text" id="add-menu-icon" name="icon" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写土地图标'" />
                	<a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="selectIcon()" plain="true">选择</a>
                </td>
            </tr>
        </table>
...
<script type="text/javascript">
	...
	*/
	...
	function openAddMenu(){
		...
		if(item == null || item.length == 0){
			$.messager.alert('信息提示','请选择要添加土地的数据！','info');
			return;
		}
		if(item.parentId == 0){
			$.messager.alert('信息提示','请选择二级土地！','info');
			return;
		}
	...
	*/
	$('#data-datagrid').treegrid({
		...
		fit:true,
		columns:[[
			{ field:'name',title:'土地名称',width:100,sortable:true},
			{ field:'url',title:'土地URL',width:100,sortable:true},
