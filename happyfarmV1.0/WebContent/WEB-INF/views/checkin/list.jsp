...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>已租姓名:</label><input id="search-name" class="wu-text" style="width:100px">
	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
	                <select id="add-roomTypeId" name="roomTypeId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择土地类型'">
		            	<c:forEach items="${roomTypeList}" var="roomType">
	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td align="right">土地类型:</td>
                <td>
	                <select id="edit-roomTypeId" name="roomTypeId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择土地类型'">
		            	<c:forEach items="${roomTypeList}" var="roomType">
		            	<option value="${roomType.id }">${roomType.name }</option>
		            	</c:forEach>
	            	</select>	
...
<script type="text/javascript">
	...
	*/
	...
	function openCheckOut(){
		$.messager.confirm('信息提示','确定要退租？', function(result){
			if(result){
				var item = $('#data-datagrid').datagrid('getSelected');
				if(item == null || item.length == 0){
					$.messager.alert('信息提示','请选择要退租的数据！','info');
					return;
				}
				if(item.status != 0){
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'roomId',title:'土地',width:100,formatter:function(value,row,index){
			...
			{ field:'roomTypeId',title:'土地类型',width:150,formatter:function(value,row,index){
			...
			{ field:'checkinPrice',title:'已租价格',width:60,sortable:true},
			{ field:'name',title:'已租人',width:60,sortable:true},
			{ field:'idCard',title:'身份证号',width:100,sortable:true},
			{ field:'mobile',title:'手机号',width:100,sortable:true},
			{ field:'arriveDate',title:'已租日期',width:100,sortable:true},
			{ field:'leaveDate',title:'日期',width:100,sortable:true},
